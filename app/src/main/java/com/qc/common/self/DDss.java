...
//            tvProgress.setText(NovelHelper.toStringProgress(imageInfo));
//            seekBar.setMax(imageInfo.getTotal() - 1);
//            seekBar.setProgress(imageInfo.getCur());
//            tvInfo.setText(String.format(Locale.CHINA, "%d章/%d章", imageInfo.getChapterId() + 1, novelInfo.getChapterInfoList().size()));
//        }
//    }
//
...
//                    NovelHelper.initChapterId(novelInfo, imageInfo.getChapterId());
...
//        readerAdapter = new NReaderAdapter(R.layout.item_reader);
...
//        if (contentInfo == null) {
//            presenter.loadImageInfoList(novel);
//        } else {
...
//            startFragment(new NReaderDetailFragment(imageInfo));
//        }
//        return true;
//    }
//
...
//
//    @Override
//    public void loadImageInfoListComplete(ContentInfo contentInfo) {
//        onComplete(contentInfo);
